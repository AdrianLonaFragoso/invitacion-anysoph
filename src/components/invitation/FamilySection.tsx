         ...
         <div className="flex flex-col sm:flex-row items-center justify-center gap-8 sm:gap-12">
           ...
           <div className="text-center flex-1">
             ...
             <div className="space-y-1">
               <p className="font-serif text-xl text-foreground">Jimena Vega</p>
               <p className="font-serif text-xl text-foreground">Adrian Lona</p>
             </div>
           </div>
           ...
           <div className="text-center flex-1">
             ...
             <div className="space-y-1">
               <p className="font-serif text-xl text-foreground">Marisa P. Dávila</p>
               <p className="font-serif text-xl text-foreground">Felipe Cano</p>
             </div>
           </div>
         </div>
       </motion.div>
