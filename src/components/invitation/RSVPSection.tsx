...
const RSVPSection = () => {
  ...
  const handleConfirm = () => {
    ...
    const attendanceText =
      attendance === "yes" ? "Sí asistiré" : "No podré asistir";
      ...
      <section className="py-16 px-4">
        ...
        >
          ...
          <div className="divider-ornament max-w-xs mx-auto mb-8">
            <span className="font-script text-3xl text-gold">Confirmación</span>
          </div>
            ...
            >
              <div className="card-elegant rounded-3xl p-6 sm:p-8 relative">
                ...
                <motion.button
                  ...
                  whileHover={
                    guestName.trim() && attendance ? { scale: 1.02 } : {}
                  }
                  whileTap={
                    guestName.trim() && attendance ? { scale: 0.98 } : {}
                  }
                >
                  <Send className="w-5 h-5" />
                  Enviar por WhatsApp
